    ...
    <div style="display: flex; gap:10px; flex-wrap: wrap; justify-content:center">
        ...
        <div style="width:220px; padding: 20px; border: solid rgb(218, 218, 218) 1px; border-radius:15px; background-color:white">
            ...
            <div style="height: 180px; position:relative">
                ...
                <a href="/generarfactura/{{$product->id}}" style="position:absolute; bottom:0px;border-style:none; border-radius:10px; padding:5px 20px 5px 20px; background-color:rgb(57, 179, 255)"  style="width: 22px">
