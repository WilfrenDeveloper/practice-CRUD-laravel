    ...
    <div style="display: flex">
        ...
        <div>
            ...
            <br>
                ...
                <form action="/" method="POST" style="display:flex; flex-direction:column; gap: 20px; width:300px">
                    @csrf
                    <div style="display: flex; flex-direction:column; gap:5px" class="mb-3">
                        <label for="id_producto" class="form-label" ></label>
                        <input id="id_producto" type="text" name="id_producto" class="form-control" tabindex="1" value="{{$producto->id}}" style="display:none">
                    </div>
                    <div style="display: flex; flex-direction:column; gap:5px" class="mb-3">
