    ...
    <form id="form_editarProducto" class="form_edit_product" action="/inventario/{{$producto->id}}" method="POST" onsubmit="return validateEditProduct()" enctype="multipart/form-data"  style="display:flex; flex-direction:column; align-items:center; gap: 20px; padding: 20px; background-color:white; border: 1px solid rgb(218, 216, 216)">
        @csrf
        @method('PUT')
